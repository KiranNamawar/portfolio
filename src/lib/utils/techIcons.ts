...
export function getTechIcon(tech: string): TechIcon {
	...
	> = {
		javascript: { icon: 'javascript', preferredVariant: 'original' },
		js: { icon: 'javascript', preferredVariant: 'original' },
		typescript: { icon: 'typescript', preferredVariant: 'original' },
		ts: { icon: 'typescript', preferredVariant: 'original' },
		...
		python: { icon: 'python', preferredVariant: 'original' },
		...
		pnpm: { icon: 'pnpm', preferredVariant: 'original' },
		bun: { icon: 'bun', preferredVariant: 'original' },
